  ...
  const commonOptions = {
    ...
    plugins: {
      legend: {
        ...
        labels: {
          color: var(--color-border), // slate-200
          font: {
    ...
    datasets: [
      {
        ...
        borderColor: var(--color-positive), // emerald-500
      ...
      },
      {
        ...
        borderColor: var(--color-neutral), // amber-500
        backgroundColor: 'rgba(245, 158, 11, 0.05)',
        tension: 0.35,
        borderWidth: 2,
        pointBackgroundColor: var(--color-neutral),
        pointRadius: 2,
        pointHoverRadius: 5,
      },
      {
        ...
        borderColor: var(--color-negative), // rose-500
